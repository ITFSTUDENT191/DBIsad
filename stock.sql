...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2019 at 07:08 PM
...
INSERT INTO `employees` (`emp_id`, `user_id`, `user_pass`, `emp_name`, `role`) VALUES
...
--
ALTER TABLE `check_out`
  ADD CONSTRAINT `FK_checking` FOREIGN KEY (`emp_id`) REFERENCES `employees` (`emp_id`);

--
-- Constraints for table `locations`
--
ALTER TABLE `locations`
  ADD CONSTRAINT `FK_loca_emp` FOREIGN KEY (`emp_id`) REFERENCES `employees` (`emp_id`);
